...
print '-----------------------------------------------------------------------------'
print table.format("Port", "Intvl", "Rx Mbps", "Rx %", "Rx Kpps", "Tx Mbps", "Tx %", "Tx Kpps")
print '-----------------------------------------------------------------------------'	
for i in root.iter(if_manager + 'ROW_interface'):
	try:
		...
		rx_mbps = round((rx_bps / 1024), 1)
		rx_pcnt = (rx_bps / 1024) * 100 / bw
		...
		tx_mbps = round((tx_bps / 1024), 1)
		tx_pcnt = (tx_bps / 1024) * 100 / bw
